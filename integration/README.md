...
- `ApiClientError.requestId` — номер из ответа сервера для сообщения об ошибке и поиска в логах; отсутствует, если заголовки ещё не получены. [Как отлаживать](../docs/DEBUGGING.md).
